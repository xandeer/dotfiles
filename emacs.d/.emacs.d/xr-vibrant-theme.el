;; xr-vibrant-theme.el --- a more vibrant version of doom-one -*- no-byte-compile: t; -*-
(require 'doom-themes)

;;
(defgroup xr-vibrant-theme nil
  "Options for doom-themes"
  :group 'doom-themes)

(defcustom xr-vibrant-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'xr-vibrant-theme
  :type 'boolean)

(defcustom xr-vibrant-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'xr-vibrant-theme
  :type 'boolean)

(defcustom xr-vibrant-comment-bg xr-vibrant-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'xr-vibrant-theme
  :type 'boolean)

(defcustom xr-vibrant-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme xr-vibrant
  ...
  ((bg         '("#242730" nil       nil))
   ...
   (selection      dark-blue)
   (builtin        magenta)
   (comments       (if xr-vibrant-brighter-comments dark-cyan base5))
   (doc-comments   (if xr-vibrant-brighter-comments (doom-lighten dark-cyan 0.15) (doom-lighten base4 0.3)))
   (constants      violet)
   (functions      cyan)
   (keywords       blue)
   (methods        violet)
   ...
   (-modeline-pad
    (when xr-vibrant-padded-modeline
      (if (integerp xr-vibrant-padded-modeline) xr-vibrant-padded-modeline 4)))

   (modeline-fg     "#bbc2cf")
   (modeline-fg-alt (doom-blend blue grey (if xr-vibrant-brighter-modeline 0.4 0.08)))

   (modeline-bg
    (if xr-vibrant-brighter-modeline
        `("#383f58" ,@(cdr base1))
  ...
  (((all-the-icons-dblue &override) :foreground dark-cyan)
   ...
   (font-lock-comment-face
    :foreground comments
    :background (if xr-vibrant-comment-bg (doom-darken bg-alt 0.095)))
   (font-lock-doc-face
   ...
   (doom-modeline-bar :background (if xr-vibrant-brighter-modeline modeline-bg highlight))
   (doom-modeline-buffer-path :foreground (if xr-vibrant-brighter-modeline base8 blue) :bold bold)
   ...
   (mode-line-emphasis
    :foreground (if xr-vibrant-brighter-modeline base8 highlight))
