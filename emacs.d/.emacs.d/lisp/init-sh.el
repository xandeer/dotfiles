...
(with-eval-after-load 'org
  (setq eshell-aliases-file (xr/expand-note "etc/eshell.alias")))
...
(with-eval-after-load 'eshell
  ...
  (with-eval-after-load 'consult
    ...
    (defun xr/consult-eshell-history ()
    ...
    (add-hook 'eshell-mode-hook (lambda () (define-key eshell-mode-map [(control ?s)] #'xr/consult-eshell-history)))))
