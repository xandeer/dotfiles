...
(defhydra x-hydra-roam-global (:exit t :columns 4)
  "
Roam\n"
  ("r" org-roam-node-random "random" :exit nil)
  ("f" org-roam-node-find "find")
  ("g" x/roam-node-find-other-window "find other window")
  ("b" consult-buffer "consult buffer")
  ("t" org-roam-dailies-goto-today "today")
  ("." org-roam-dailies-goto-today "today")
  ("y" org-roam-dailies-goto-yesterday "yesterday")
  ("," org-roam-dailies-goto-yesterday "yesterday")
...
(define-key org-mode-map (kbd "H-r") #'x-hydra-roam-org/body)
