...
;; nvidia
(setq x/gpt--nvidia-models '(minimaxai/minimax-m2.7))
(setq x/gpt--nvidia-token (auth-source-pick-first-password :host "nvidia" :user "gptel"))
(setq x/gpt--backend-nvidia (gptel-make-openai "nvidia" ;Any name you want
...
(defun x/gpt--match-backend ()
  ...
  (setq x/gpt-backend
        (if (memq x/gpt-model x/gpt--ark-models)
            x/gpt--backend-ark
          (if (memq x/gpt-model x/gpt--nvidia-models)
              x/gpt--backend-nvidia
